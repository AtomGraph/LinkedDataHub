                                        ...
                                        <div class="controls">
                                            ...
                                            <div class="btn-group">
                                                ...
                                                <ul class="dropdown-menu">
                                                    <li>
                                                        <a href="{ldh:href($ldt:base, ldh:absolute-path(ldh:base-uri(.)), ldh:query-params(xs:anyURI('&ac;ModalMode'), xs:anyURI('&dh;Container')), ldh:absolute-path(ldh:base-uri(.)))}" class="btn add-constructor" title="&dh;Container" id="{generate-id()}-upload-rdf-container">
                                                            <xsl:value-of>
                                                        ...
                                                        <a href="{ldh:href($ldt:base, ldh:absolute-path(ldh:base-uri(.)), ldh:query-params(xs:anyURI('&ac;ModalMode'), xs:anyURI('&dh;Item')), ldh:absolute-path(ldh:base-uri(.)))}" class="btn add-constructor" title="&dh;Item" id="{generate-id()}-upload-rdf-item">
                                                            <xsl:value-of>
                                    ...
                                    <div class="control-group required">
                                        ...
                                        <div class="controls">
                                            ...
                                            <div class="btn-group">
                                                ...
                                                <ul class="dropdown-menu">
                                                    <li>
                                                        <a href="{ldh:href($ldt:base, ldh:absolute-path(ldh:base-uri(.)), ldh:query-params(xs:anyURI('&ac;ModalMode'), xs:anyURI('&dh;Container')), ldh:absolute-path(ldh:base-uri(.)))}" class="btn add-constructor" title="&dh;Container" id="{generate-id()}-remote-rdf-container">
                                                            <xsl:value-of>
                                                                <xsl:apply-templates select="key('resources', '&dh;Container', document(ac:document-uri('&dh;')))" mode="ac:label"/>
                                                            </xsl:value-of>
                                                    ...
                                                    <li>
                                                        <a href="{ldh:href($ldt:base, ldh:absolute-path(ldh:base-uri(.)), ldh:query-params(xs:anyURI('&ac;ModalMode'), xs:anyURI('&dh;Item')), ldh:absolute-path(ldh:base-uri(.)))}" type="button" class="btn add-constructor" title="&dh;Item" id="{generate-id()}-remote-rdf-item">
                                                            <xsl:value-of>
                                                                <xsl:apply-templates select="key('resources', '&dh;Item', document(ac:document-uri('&dh;')))" mode="ac:label"/>
                                                            </xsl:value-of>
                                ...
                                <fieldset>
                                    ...
                                    <div class="control-group required">
                                        ...
                                        <div class="controls">
                                            ...
                                            <a href="{ldh:href($ldt:base, ldh:absolute-path(ldh:base-uri(.)), ldh:query-params(xs:anyURI('&ac;ModalMode'), xs:anyURI('&dh;Container')), ldh:absolute-path(ldh:base-uri(.)))}" class="btn add-constructor create-action" title="&dh;Container" id="{generate-id()}-generate-containers-parent">
                                                <input type="hidden" class="forClass" value="&dh;Container"/>
                                            </a>
                                    ...
                                    <div class="control-group required">
                                        ...
                                        <div class="controls">
                                            ...
                                            <a href="{ldh:href($ldt:base, ldh:absolute-path(ldh:base-uri(.)), ldh:query-params(xs:anyURI('&ac;ModalMode'), xs:anyURI('&sd;Service')), ldh:absolute-path(ldh:base-uri(.)))}" class="btn add-constructor create-action" title="&sd;Service" id="{generate-id()}-generate-containers-service">
...
<!--                <div class="alert alert-info">
    ...
    <xsl:template name="ldh:ReconcileForm">
        ...
        <xsl:param name="button-class" select="'btn btn-primary btn-save'" as="xs:string?"/>
        <xsl:param name="accept-charset" select="'UTF-8'" as="xs:string?"/>
        <xsl:param name="action" select="ldh:absolute-path(ldh:base-uri(.))" as="xs:anyURI"/>
    ...
    <xsl:template match="button[contains-token(@class, 'btn-add-data')]" mode="ixsl:onclick">
        <xsl:call-template name="ldh:ShowAddDataForm">
            ...
            <xsl:with-param name="graph" select="ldh:absolute-path(ldh:base-uri(.))"/>
        </xsl:call-template>
    </xsl:template>
