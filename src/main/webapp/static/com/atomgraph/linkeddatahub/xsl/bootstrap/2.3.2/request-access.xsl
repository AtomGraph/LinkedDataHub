...
exclude-result-prefixes="#all">
    ...
    <xsl:template match="rdf:RDF[key('resources', ac:uri(), document(ac:uri()))/rdf:type/@rdf:resource = '&adm;RequestAccess'][$ac:method = 'POST'][key('resources-by-type', '&spin;ConstraintViolation')]" mode="xhtml:Body" priority="3">
    ...
    <xsl:template match="rdf:RDF[key('resources', ac:uri(), document(ac:uri()))/rdf:type/@rdf:resource = '&adm;RequestAccess'][$ac:method = 'GET']" mode="xhtml:Body" priority="2">
        <body>
    ...
    <!--<xsl:template match="rdf:RDF[key('resources', ac:uri(), document(ac:uri()))/rdf:type/@rdf:resource = '&adm;RequestAccess']" mode="bs2:NavBarActions" priority="2"/>-->

    <xsl:template match="rdf:RDF[key('resources', ac:uri(), document(ac:uri()))/rdf:type/@rdf:resource = '&adm;RequestAccess']" mode="bs2:ModeTabs" priority="2"/>
    ...
    <xsl:template match="*[key('resources', ac:uri(), document(ac:uri()))/rdf:type/@rdf:resource = '&adm;RequestAccess'][$ac:method = 'POST'][not(key('resources-by-type', '&http;Response'))][1]" mode="bs2:RowBlock" priority="3">
    ...
    <xsl:template match="*[key('resources', ac:uri(), document(ac:uri()))/rdf:type/@rdf:resource = '&adm;RequestAccess'][$ac:method = 'POST'][not(key('resources-by-type', '&http;Response'))]" mode="bs2:RowBlock" priority="2"/>

    <!-- hide object blank nodes (that only have a single rdf:type property) from constructed models -->
    <xsl:template match="rdf:Description[$ac:method = 'GET'][@rdf:nodeID][not(rdf:type/@rdf:resource = ('&lacl;AuthorizationRequest', '&dh;Item'))][key('resources', ac:uri(), document(ac:uri()))/rdf:type/@rdf:resource = '&adm;RequestAccess']" mode="bs2:RowForm" priority="3"/>

    <xsl:template match="*[*][@rdf:about or @rdf:nodeID][key('resources', ac:uri(), document(ac:uri()))/rdf:type/@rdf:resource = '&adm;RequestAccess']" mode="bs2:FormControl" priority="1">
        <xsl:next-match>
    ...
    <xsl:template match="*[@rdf:about or @rdf:nodeID][key('resources', ac:uri(), document(ac:uri()))/rdf:type/@rdf:resource = '&adm;RequestAccess']/sioc:has_parent | *[@rdf:about or @rdf:nodeID][key('resources', ac:uri(), document(ac:uri()))/rdf:type/@rdf:resource = '&adm;RequestAccess']/sioc:has_container" mode="bs2:FormControl" priority="4">
    ...
    <xsl:template match="lacl:requestMode/@rdf:*[key('resources', ac:uri(), document(ac:uri()))/rdf:type/@rdf:resource = '&adm;RequestAccess']" mode="bs2:FormControl" priority="2">
    ...
    <xsl:template match="lacl:requestAgent[key('resources', ac:uri(), document(ac:uri()))/rdf:type/@rdf:resource = '&adm;RequestAccess']" mode="bs2:FormControl" priority="2">
        <xsl:apply-templates select="." mode="xhtml:Input">
            <xsl:with-param name="type" select="'hidden'"/>
        </xsl:apply-templates>
    ...
    <xsl:template match="lacl:requestAccessTo/@rdf:*[key('resources', ac:uri(), document(ac:uri()))/rdf:type/@rdf:resource = '&adm;RequestAccess'][$ldh:access-to]" mode="bs2:FormControl" priority="2">
    ...
    <xsl:template match="lacl:requestAccessToClass[1]/@rdf:*[key('resources', ac:uri(), document(ac:uri()))/rdf:type/@rdf:resource = '&adm;RequestAccess']" mode="bs2:FormControl" priority="2">
        <xsl:variable name="this" select="../concat(namespace-uri(), local-name())" as="xs:string"/>
    ...
    <xsl:template match="lacl:requestAccessToClass/@rdf:*[key('resources', ac:uri(), document(ac:uri()))/rdf:type/@rdf:resource = '&adm;RequestAccess']" mode="bs2:FormControl" priority="1"/>
    
    <!-- hide type control -->
    <xsl:template match="*[*][@rdf:about or @rdf:nodeID][key('resources', ac:uri(), document(ac:uri()))/rdf:type/@rdf:resource = '&adm;RequestAccess']" mode="bs2:TypeControl" priority="2">
        <xsl:next-match>
    ...
    <!-- suppress properties -->
    <xsl:template match="dct:title[key('resources', ac:uri(), document(ac:uri()))/rdf:type/@rdf:resource = '&adm;RequestAccess'] | dct:description[key('resources', ac:uri(), document(ac:uri()))/rdf:type/@rdf:resource = '&adm;RequestAccess'] | ldh:content[key('resources', ac:uri(), document(ac:uri()))/rdf:type/@rdf:resource = '&adm;RequestAccess']" mode="bs2:FormControl" priority="4"/>

    <!-- hide properties (including all of document resource properties) -->
    <xsl:template match="rdfs:label[key('resources', ac:uri(), document(ac:uri()))/rdf:type/@rdf:resource = '&adm;RequestAccess'] | foaf:isPrimaryTopicOf[key('resources', ac:uri(), document(ac:uri()))/rdf:type/@rdf:resource = '&adm;RequestAccess'] | *[foaf:primaryTopic][key('resources', ac:uri(), document(ac:uri()))/rdf:type/@rdf:resource = '&adm;RequestAccess']/*" mode="bs2:FormControl" priority="3">
        <xsl:apply-templates select="." mode="xhtml:Input">
            <xsl:with-param name="type" select="'hidden'"/>
        </xsl:apply-templates>
    ...
    <xsl:template match="*[key('resources', ac:uri(), document(ac:uri()))/rdf:type/@rdf:resource = '&adm;RequestAccess']" mode="bs2:PropertyControl" priority="1"/>
