...
<!--        <xsl:sequence select="ac:label(.)"/>-->
    ...
    <xsl:template match="*[rdf:type/@rdf:resource = '&apl;Content']" mode="bs2:TypeControl" priority="2">
        <xsl:next-match>
    ...
    <xsl:template match="*[rdf:type/@rdf:resource = '&apl;Content']/rdf:rest" mode="bs2:Form" priority="1">
