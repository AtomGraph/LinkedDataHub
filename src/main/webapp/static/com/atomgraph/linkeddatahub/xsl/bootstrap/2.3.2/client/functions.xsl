...
<xsl:message>@name: <xsl:value-of select="@name"/> $skip-input/@name: <xsl:value-of select="$skip-input/@name"/> $skip-input/ixsl:get(., 'value'): <xsl:value-of select="$skip-input/ixsl:get(., 'value')"/></xsl:message>
