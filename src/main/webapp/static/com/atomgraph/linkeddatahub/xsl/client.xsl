...
>
    ...
    <xsl:template name="main">
        ...
        <xsl:message use-when="not(system-property('saxon:platform') eq 'Browser')">NOT BROWSER</xsl:message>
        <xsl:message use-when="system-property('saxon:platform') eq 'Browser'">BROWSER</xsl:message>
