...
>
    ...
    <xsl:template match="rdf:RDF[not(key('resources', ac:uri()))][key('resources-by-type', '&http;Response')][not(key('resources-by-type', ('&spin;ConstraintViolation', '&sh;Violation')))]" mode="xhtml:Body" priority="1">
