...
>
    ...
    <xsl:template match="rdf:RDF" mode="ac:ActionBarLeft">
        <xsl:param name="id" as="xs:string?"/>
    ...
    <xsl:template match="rdf:RDF[key('resources-by-type', '&http;Response')]" mode="ac:HeaderActions" priority="1"/>

    <xsl:template match="rdf:RDF" mode="ac:HeaderActions">
            ...
            <div class="ldh-of-wrap ldhc-menu-anchor">
                ...
                <div class="ldh-of-menu">
                    <xsl:if test="$ldh:ajaxRendering">
                        ...
                        <xsl:apply-templates select="." mode="ldh:AddData"/>
                    </xsl:if>
    ...
    <xsl:template match="rdf:RDF[key('resources-by-type', '&http;Response')]" mode="ac:MediaTypeList" priority="1"/>
    ...
    <xsl:template match="rdf:RDF" mode="ldh:TabBody">
        ...
        <div>
            ...
            <xsl:apply-templates select="." mode="ldh:DocumentBody">
    ...
    <xsl:template match="rdf:RDF[key('resources-by-type', '&http;Response') and not(key('resources-by-type', '&spin;ConstraintViolation')) and not(key('resources-by-type', '&sh;ValidationResult'))]" mode="ldh:ContentBody" priority="1">
        <xsl:param name="id" as="xs:string?"/>
        ...
        <div>
            ...
            <!-- error responses always rendered in ldh:BlockRow mode, no matter what $mode specifies -->
    ...
    <xsl:template match="srx:sparql" mode="ldh:ContentBody">
        <xsl:param name="id" as="xs:string?"/>
        <xsl:param name="class" select="'content-body'" as="xs:string?"/>
    ...
    <xsl:template match="rdf:RDF" mode="ldh:ContentBody">
        <xsl:param name="id" as="xs:string?"/>
        <xsl:param name="class" select="'content-body'" as="xs:string?"/>
    ...
    <xsl:template match="rdf:RDF[key('resources-by-type', '&http;Response') and not(key('resources-by-type', '&spin;ConstraintViolation')) and not(key('resources-by-type', '&sh;ValidationResult'))]" mode="ac:ActionBar" priority="1"/>
    ...
    <xsl:template match="rdf:RDF | srx:sparql" mode="ldh:Chart">
    ...
    <xsl:template match="rdf:RDF" mode="ac:ResourceForm" name="ac:ResourceForm">
        ...
        <xsl:param name="id" select="concat('form-', generate-id())" as="xs:string?"/>
        <xsl:param name="class" select="'ldh-edit-form'" as="xs:string?"/>
        <xsl:param name="form-actions-class" select="'ldh-form-bar pl-inline'" as="xs:string?"/>
    ...
    <xsl:template match="rdf:RDF | srx:sparql" mode="ac:Create" priority="1">
        ...
        <div>
            ...
            <div class="ldh-add-menu">
                ...
                <xsl:apply-templates select="$classes" mode="ldh:ConstructorListItem">
                    <xsl:with-param name="create-graph" select="$create-graph"/>
                    <xsl:with-param name="base-uri" select="$base-uri" tunnel="yes"/>
                    <xsl:sort select="ac:label(.)"/>
                </xsl:apply-templates>
    ...
    <xsl:template match="rdf:RDF" mode="ldh:Object">
        <xsl:apply-templates mode="#current"/>
    </xsl:template>
