...
public class CSVGraphStoreOutput // extends com.atomgraph.etl.csv.stream.CSVStreamRDFOutput
{
     ...
     */
    public CSVGraphStoreOutput(Service service, Service adminService, com.atomgraph.linkeddatahub.Application system, GraphStoreClient gsc, String base, Reader reader, Query query, char delimiter, Integer maxCharsPerColumn)
    {
        this.base = base;
        this.reader = reader;
        this.query = query;
        ...
        this.processor = new CSVGraphStoreRowProcessor(service, adminService, system, gsc, base, query);
