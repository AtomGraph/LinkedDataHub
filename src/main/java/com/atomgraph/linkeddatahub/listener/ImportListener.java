...
public class ImportListener implements ServletContextListener
{
    ...
    public static void submit(CSVImport csvImport, com.atomgraph.linkeddatahub.server.model.Resource importRes, Resource provGraph, Application app, String baseURI, DataManager dataManager)
    {
        ...
        new Executor(THREAD_POOL).start(csvImport, importRes, provGraph, app, baseURI, dataManager);
    }

    public static void submit(RDFImport rdfImport, com.atomgraph.linkeddatahub.server.model.Resource importRes, Resource provGraph, Application app, String baseURI, DataManager dataManager)
    {
        ...
        new Executor(THREAD_POOL).start(rdfImport, importRes, provGraph, app, baseURI, dataManager);
    }
