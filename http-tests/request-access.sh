...
curl -w "%{http_code}\n" -k -s \
  ...
  --data-urlencode "ou=${END_USER_BASE_URL}ns/default#Root" \
  --data-urlencode "ou=${END_USER_BASE_URL}ns/default#Container" \
  --data-urlencode "ou=${END_USER_BASE_URL}ns/default#Item" \
  --data-urlencode "ou=${END_USER_BASE_URL}ns/default#File" \
