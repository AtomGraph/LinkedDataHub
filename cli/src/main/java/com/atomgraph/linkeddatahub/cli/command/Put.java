...
/**
 * Creates or updates an RDF document from a file or standard input. Mirrors <code>bin/put.sh</code>.
 *
 * @author Martynas Jusevičius {@literal <martynas@atomgraph.com>}
 */
@Command(name = "put", description = "Creates or updates an RDF document from a file or stdin.")
public class Put extends BaseCommand
{
    ...
    public Integer call() throws Exception
    {
        ...
        HttpException.check(target, getClient().put(target, Entity.entity(model, MediaType.valueOf(mediaType)), ACCEPT_TURTLE)).close();
        print(target);
