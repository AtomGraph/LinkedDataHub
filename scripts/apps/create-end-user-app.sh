...
if [ "$#" -ne 8 ]; then
  ...
  echo "Example: $0" 'https://linkeddatahub.com/atomgraph/ ../../certs/martynas.linkeddatahub.pem Password "City Graph" city-graph https://linkeddatahub.com/atomgraph/city-graph/ https://linkeddatahub.com/atomgraph/apps/admin/city-graph https://linkeddatahub.com/atomgraph/services/city-graph' >&2
  exit 1
fi
