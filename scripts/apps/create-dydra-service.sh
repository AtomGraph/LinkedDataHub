...
if [ "$#" -ne 8 ]; then
  ...
  echo "Example: $0" 'https://linkeddatahub.com/atomgraph/ martynas.linkeddatahub.pem Password "City Graph" city-graph http://atomgraph.dydra.com/city-graph/prod ServiceUser ServicePassword' >&2
  exit 1
fi
