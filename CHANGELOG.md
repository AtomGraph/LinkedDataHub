...
- `http-tests/dataspaces/sitemap.sh` drives both dataspaces of the test stack, which share their stores, and fails on a `<loc>` or a `Sitemap:` line belonging to the other one
